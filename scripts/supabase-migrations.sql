-- Run this in Supabase SQL Editor for project bafowilqrykdwycgpnbd
-- Copy and run each section in order (or all at once for fresh DB)

-- ========== MIGRATION 1: Initial schema ==========
CREATE TYPE "plan" AS ENUM ('free', 'pro', 'team', 'enterprise');
CREATE TYPE "integration_source" AS ENUM ('slack', 'zoom', 'google', 'gmail', 'linkedin', 'github');
